  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-[rgb(var(--primary))] focus-visible:ring-[3px] focus-visible:ring-[rgb(var(--primary)/0.16)]",
        "aria-invalid:ring-[rgb(var(--error)/0.2)] dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
        className,
      )}
      {...props}
    />
